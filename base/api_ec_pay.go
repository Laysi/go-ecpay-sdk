...
func (r apiCallbackReturnURLPostRequest) PaymentType(paymentType PaymentType) apiCallbackReturnURLPostRequest {
...
*/
func (a *ECPayApiService) CallbackReturnURLPost(ctx _context.Context) apiCallbackReturnURLPostRequest {
	return apiCallbackReturnURLPostRequest{
		apiService: a,
		ctx:        ctx,
	}
...
func (r apiCallbackReturnURLPostRequest) Execute() (string, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ECPayApiService.CallbackReturnURLPost")
	if err != nil {
