...
type ReturnData struct {
	...
	// **通路費**
	PaymentTypeChargeFee int32 `json:"PaymentTypeChargeFee"`
...
// GetCustomField5 returns the CustomField5 field value
...
// GetCustomField5Ok returns a tuple with the CustomField5 field value
// and a boolean to check if the value has been set.
...
// SetCustomField5 sets field value
...
func (o ReturnData) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["CustomField5"] = o.CustomField5
	}
