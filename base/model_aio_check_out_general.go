...
// AioCheckOutGeneral struct for AioCheckOutGeneral
type AioCheckOutGeneral struct {
	// **特店編號(由綠界提供)**
...
func (o AioCheckOutGeneral) MarshalJSON() ([]byte, error) {
...
type NullableAioCheckOutGeneral struct {
	value *AioCheckOutGeneral
	isSet bool
}

func (v NullableAioCheckOutGeneral) Get() *AioCheckOutGeneral {
	return v.value
}

func (v *NullableAioCheckOutGeneral) Set(val *AioCheckOutGeneral) {
	v.value = val
	v.isSet = true
}

func (v NullableAioCheckOutGeneral) IsSet() bool {
	return v.isSet
}

func (v *NullableAioCheckOutGeneral) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAioCheckOutGeneral(val *AioCheckOutGeneral) *NullableAioCheckOutGeneral {
	return &NullableAioCheckOutGeneral{value: val, isSet: true}
}

func (v NullableAioCheckOutGeneral) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAioCheckOutGeneral) UnmarshalJSON(src []byte) error {
	v.isSet = true
